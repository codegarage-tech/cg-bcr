...
public class ImageProcessingActivity extends Activity {
    ...
    private ImageView ivCrop, ivClose, ivRotate,ivInvert,ivAlign;
...
//        btnClose.setText(ScannerConstants.backText);
        ...
        if (progressBar.getIndeterminateDrawable()!=null && ScannerConstants.progressColor!=null)
            progressBar.getIndeterminateDrawable().setColorFilter(Color.parseColor(ScannerConstants.progressColor), PorterDuff.Mode.MULTIPLY);
        else if (progressBar.getProgressDrawable()!=null && ScannerConstants.progressColor!=null)
            progressBar.getProgressDrawable().setColorFilter(Color.parseColor(ScannerConstants.progressColor), PorterDuff.Mode.MULTIPLY);
        setProgressBar(true);
        ...
        Observable.fromCallable(() -> {
            ...
            return false;
                ...
                .subscribe((result) -> {
                    ...
                    ivCrop.setOnClickListener(btnImageEnhanceClick);
                    ivClose.setOnClickListener(btnCloseClick);
                    ivRotate.setOnClickListener(onRotateClick);
                    ivInvert.setOnClickListener(btnInvertColor);
                    ivAlign.setOnClickListener(btnRebase);
                });
    }
    ...
    protected Bitmap getCroppedImage() {
        ...
        }catch (Exception e)
        {
            runOnUiThread(new Runnable() {
                @Override
                public void run() {
                    Toast.makeText(ImageProcessingActivity.this,ScannerConstants.cropError,Toast.LENGTH_SHORT).show();
                }
            });
            return  null;
        }
