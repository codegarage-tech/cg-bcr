...
public class CompressHelper {
    private String TAG = CompressHelper.class.getSimpleName();
...
//        destinationDirectoryPath = context.getCacheDir().getPath() + File.pathSeparator + FileUtil.FILES_PATH;
        destinationDirectoryPath = Environment.getExternalStorageDirectory().getAbsolutePath()+ File.separator + getAppName(context);
        Log.d(TAG, "Destination path: "+ destinationDirectoryPath);
    }
    ...
    public File compressToFile(File file) {
        Log.d(TAG, "Source path: " + file.getAbsolutePath() + " maxWidth: " + maxWidth+" maxHeight: "+maxHeight);
